sentientPOC.scheduleTabs = (function () {
    ...
    var initScheduler = function() {
        ...
        scheduler.parse([
			...
			{ start_date: "2014-06-30 08:00", end_date: "2014-06-30 12:00", text: "Task C-32421", section_id: 60 },
			{ start_date: "2014-06-30 14:30", end_date: "2014-06-30 16:45", text: "Task C-14244", section_id: 60 },

			{ start_date: "2014-06-30 09:20", end_date: "2014-06-30 12:20", text: "Task D-52688", section_id: 80 },
			{ start_date: "2014-06-30 11:40", end_date: "2014-06-30 16:30", text: "Task D-46588", section_id: 80 },
			{ start_date: "2014-06-30 12:00", end_date: "2014-06-30 18:00", text: "Task D-12458", section_id: 80 }
        ], "json");
    };
